...
function addToCart(target) {
  ...
  const cartItem =
    target.parentNode.childNodes[1].childNodes[3].childNodes[3].childNodes[3]
      .innerText;
  ...
  const price =
    target.parentNode.childNodes[1].childNodes[3].childNodes[3].childNodes[5].innerText.split(
      " "
    )[0];
